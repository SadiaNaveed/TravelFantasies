...
var tourReviewRouter = require("./routes/api/tourReview");
...
var RequestGuide = require("./routes/api/RequestGuide");
var BookGuidesRouter = require("./routes/api/BookGuides");
...
app.use("/api/tourReview", tourReviewRouter);
...
app.use("/api/RequestGuide", RequestGuide);
app.use("/api/BookGuides", BookGuidesRouter);
